# metrics_rouge.py
"""
ROUGE-L (pycocoevalcap) for report-generation evaluation.
...
def compute_rouge_batch(
    ...
    """
    Compute ROUGE-L at sentence and corpus level.
    ...
    -------
    Tuple[Dict[str, float], float]
        - sentence_dict: study_id -> rouge_l_score (0–1)
        - corpus_score: mean ROUGE-L score across all samples (0–1)
    """
    scorer = Rouge()
