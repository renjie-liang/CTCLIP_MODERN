#!/bin/bash
# Alternative version with reduced CPU resources (32 CPUs)
# Use this if 40 CPUs are not available on your cluster
...
echo "========================================"
echo "Config file: configs/base_config_reduced_cpu.yaml"
echo "Data format: WebDataset (float16)"
echo "Mixed precision: Enabled (fp16)"
echo "Batch size: 32"
echo "Num workers: 24 (reduced for 32 CPUs)"
echo "Max steps: 10000"
echo "========================================"
echo ""

# Start training with reduced CPU config
echo "Starting training at $(date)"
echo ""

python train.py --config configs/base_config_reduced_cpu.yaml
